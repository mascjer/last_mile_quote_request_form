...
from pages.local_pick_delivery_finished_callbacks import add_local_pick_delivery_finished_callbacks

add_local_pick_delivery_finished_callbacks(dash)


dash.register_page(__name__, 
                    path='/local_pick_delivery_finished',
...
layout = dbc.Container([
    ...
    html.Div(style={'border-width':'1px', 'border-style':'solid', 'border-color':'black', 'border-top-width': '0px'}, children = [
        ...
        dbc.Row([
            dbc.Col([
                html.Div(id='confirmation-div-2'),
        ...
        dbc.Row([
            dbc.Col([
                dcc.Loading(children = [html.Div(id='prompt-2')], fullscreen = True),
            ],width={"size": 10, "offset": 1}, md=10, align='stretch'),
        ]),
